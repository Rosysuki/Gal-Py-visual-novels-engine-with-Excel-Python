...
#__all__ = ["PyScreen" ,"SimpleMixer" ,"partial" ,"color" ,"pygame"]

if "PyScreen.py" in __file__:
    import pygame
    ...
    RunData = NewType("RunData" ,Exception)
...
if __name__ == "__main__":
    ...
    print(repr(r"‪C:\Users\sfuch\Desktop\pic\cute.png"))
    screen: PyScreen = PyScreen("OK" ,(600 ,500))
    screen.width ,screen.height = 600 ,600
    screen.init()
    #screen.screen.blit(pygame.font.SysFont("幼圆" ,36).render("YES" ,True ,(100 ,0 ,0)) ,(0 ,0))
    screen.say("OKOK" ,0 ,0 ,size=39 ,color=(200 ,100 ,0))
    #screen.MAIN(r"‪C:\Users\sfuch\Desktop\pic\cute.png")
    screen.MAIN(r"C:\Users\sfuch\Desktop\pic\cute.png")
    screen.flash()
    pass
